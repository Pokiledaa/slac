...
from enums import BUFF_MAX_SIZE, Timers
from sockets.enums import (
    BPF_ABS,
    BPF_H,
    BPF_JEQ,
    BPF_JMP,
...
filters_list = [
    ...
    # returning failure (0)
    bpf_jump(BPF_JMP | BPF_JEQ | BPF_K, ETH_HC_LISTEN_FOR_SLAC_ASSN, 0, 1),
